...
200414: added CcatLatv2b which separates out the tubes to be varied separately
200831: updated instantaneous sensitivities with spillover efficiency corrections with Gordon Stacey, and including latest PWV measurements from 2007.04262 (from CCAT-Prime_SZ-FPI_20200812.xlsx)
added v2c which gives sensitivities in the 1st quartile weather
...
class CcatLatv2c(SOLatType):
    ...
    def __init__(self, sensitivity_mode=None,
        ...
        self.tube_configs = {
            ...
            # from gordon's spreadsheet for 1
            'HF1': nar([5.7,    0,    0,    0, 0]),
            'HF2': nar([0, 10.3,    0,    0, 0]),
            'HF3': nar([0,   0, 35.4,    0, 0]),
            'HF4': nar([0,   0,    0, 129.4, 0]),
            'HF5': nar([0,   0,    0,    0, 195582.5]),
        }
